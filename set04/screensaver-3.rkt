...
;; rect-bottom-edge : Rectangle -> NonNegInt
;; GIVEN: a rectangle
...
;;   (make-rect 112 30 25 -14 0 0 #true)
...
;;   (make-rect 112 30 21 -14 0 0 #true)
...
;;   (make-rect 112 30 23 -12 0 0 #true)
;; (rect-with-increased-x-vel r2) = r2
;; STRATEGY: Use template for Rect on r
...
;;   (make-rect 112 30 23 -16 0 0 #true)
...
;;   (list (make-rect 200 100 -12 20 -10 -3 #true) r2)
;; (rects-after-mouse-event (list r5 r6) 110 25 "drag") =
;;   (list (make-rect 110 25 23 -14 0 0 #true) r6)
;; (rects-after-mouse-event (list r5 r6) 110 25 "button-up") =
;;   (list (make-rect 110 25 23 -14 0 0 #false) r6)
